...
public class ControllerCustomerRoomFourPage implements Initializable {
    ...
    @FXML
    public ObservableList<RoomCalender> cLoadDataFromDatabasefour(String room_name_live) {
