...
public class ControllerCustomerRoomFivePage implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ObservableList<RoomCalender> list = cLoadDataFromDatabaseFive("ananas");
    ...
    @FXML
    public ObservableList<RoomCalender> cLoadDataFromDatabaseFive(String room_name_live) {
