...
public class ControllerCustomerRoomThreePage implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ObservableList<RoomCalender> list = cLoadDataFromDatabasethree("avokado");
    ...
    @FXML
    public ObservableList<RoomCalender> cLoadDataFromDatabasethree(String room_name_live) {
